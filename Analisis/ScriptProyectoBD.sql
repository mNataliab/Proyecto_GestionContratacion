...
CREATE TABLE IF NOT EXISTS `ProyectoPhP`.`Persona` (
  ...
  `Tipo_Usuario` ENUM('Administrador', 'General', 'SubGeneral', 'Secretario') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ProyectoPhP`.`Secretarias` (
  ...
  INDEX `fk_Secretarias_Persona_idx` (`Persona_idPersona` ASC),
  CONSTRAINT `fk_Secretarias_Persona`
