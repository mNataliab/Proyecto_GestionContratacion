...
-- -----------------------------------------------------
-- Table `mydb`.`Contatos_Publicos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Contatos_Publicos` (
...
-- -----------------------------------------------------
-- Table `mydb`.`Liquidacion_Contrato`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Liquidacion_Contrato` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`Documentos` (
  ...
  CONSTRAINT `fk_Documentos_Contatos_Publicos1`
    ...
    REFERENCES `mydb`.`Contatos_Publicos` (`idContatos_Publicos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_Documentos_Liquidacion_Contrato1`
    ...
    REFERENCES `mydb`.`Liquidacion_Contrato` (`idLiquidacion_Contrato`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`Registro_Actas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Registro_Actas` (
...
-- -----------------------------------------------------
-- Table `mydb`.`Registro_Cumplimientos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Registro_Cumplimientos` (
...
-- -----------------------------------------------------
-- Table `mydb`.`Registro_Certificados`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Registro_Certificados` (
  ...
  CONSTRAINT `fk_Registro_Certificados_Registro_Cumplimientos1`
    ...
    REFERENCES `mydb`.`Registro_Cumplimientos` (`idRegistro_Cumplimientos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`persona_secretaria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`persona_secretaria` (
  `Persona_idPersona` INT UNSIGNED NOT NULL,
  `Secretarias_idSecretarias` INT UNSIGNED NOT NULL,
  INDEX `fk_persona_secretaria_Persona1_idx` (`Persona_idPersona` ASC),
  INDEX `fk_persona_secretaria_Secretarias1_idx` (`Secretarias_idSecretarias` ASC),
  CONSTRAINT `fk_persona_secretaria_Persona1`
    FOREIGN KEY (`Persona_idPersona`)
    REFERENCES `mydb`.`Persona` (`idPersona`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_persona_secretaria_Secretarias1`
    FOREIGN KEY (`Secretarias_idSecretarias`)
    REFERENCES `mydb`.`Secretarias` (`idSecretarias`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
